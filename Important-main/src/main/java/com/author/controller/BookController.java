...
public class BookController {
	...
	public List<BookReaderDto> getBooksSimple(@PathVariable String email)
	{
	...
	public List<BookContentDto> getContentBook(@PathVariable String email,@PathVariable Integer bId)
	{
